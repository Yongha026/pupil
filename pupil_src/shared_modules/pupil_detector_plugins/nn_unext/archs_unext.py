...
class OverlapPatchEmbed(nn.Module):
    ...
    def __init__(self, img_size=192, patch_size=7, stride=4, in_chans=3, embed_dim=768):
        super().__init__()
...
class UNext(nn.Module):
    ...
    def __init__(self, num_classes, input_channels=3, deep_supervision=False, img_size=192, patch_size=16, in_chans=3,
